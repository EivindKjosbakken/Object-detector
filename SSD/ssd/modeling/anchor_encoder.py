...
class AnchorEncoder(object):
    ...
    def encode(self, bboxes_in: torch.Tensor, labels_in: torch.Tensor, iou_threshold: float):
        ...
        labels_out = torch.zeros(self.nboxes, dtype=torch.long) # TODO changed form torch.long to torch.int
        #labels_out[masks] = labels_in[best_target_per_anchor_idx[masks]] #TODO changed
