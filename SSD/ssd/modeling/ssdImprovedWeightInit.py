...
class SSD300ImprovedWeightInit(nn.Module):
    def __init__(self, 
    ...
    def _init_weights(self):
        ...
        for layer in layers:
            ...
            if (counter==12):
                p = 0.99
                K = 9 #num classes
                backroundBias = np.log(p * (K-1)/(1-p))
                nn.init.constant_(layer.bias[:4], backroundBias) #the 4 first = class 0
